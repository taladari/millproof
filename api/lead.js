  ...
  try {
    ...
    await send({
      ...
      text: [
        ...
        `--------------------------------------------------------------------`,
        ``,
        `1. Send the supplier request below to whoever holds the mill certificates for the lines`,
        `   marked in scope. Nothing else produces the weights, and the request is what starts it.`,
        `2. Where a line says "depends on statistical suffix", compare the listed 10-digit codes`,
        `   against what you actually declare. At eight digits you cannot tell whether 232 applies,`,
        `   which means you may be paying on a line that is out of scope, or the reverse.`,
        `3. Forward this email to your broker or your controller. It is plain text on purpose.`,
        ``,
